...
export default function AccountPage() {
  ...
  const [personalVisible, setPersonalVisible] =
  ...
  useEffect(() => {
    try {
      ...
      const storedSessions =
        localStorage.getItem("satark_sessions");
      ...
      const twoFAValue =
        localStorage.getItem("satark_2fa_enabled");

      setTwoFA(twoFAValue === "1");
      const locationValue = localStorage.getItem(
        "satark_allow_location"
      );

      setLocationPerm(locationValue !== "0");
      const privateProfile = localStorage.getItem(
  ...
  const downloadData = () => {
    const data = {
      ...
      safeLocations: localStorage.getItem(
  ...
  const changePassword = async (newPass: string) => {
    if (newPass.trim().length < 8) {
      showToast(
        language === "np"
          ? "पासवर्ड कम्तीमा ८ वर्णको हुनुपर्छ"
  ...
  return (
    <>
      ...
      <ConfirmationModal
        ...
        message={
          language === "np"
            ? "के तपाइँ खातालाई स्थायी रुपमा हटाउन निश्चित हुनुहुन्छ? यो कार्य फर्काउन सकिँदैन।"
      ...
      <div className="bg-navy-900 border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col sm:flex-row items-center gap-4">
        ...
        <div className="ml-auto flex gap-2">
          ...
          <Link
            href="/profile/edit"
            className="px-3 py-2 bg-amber-400 text-slate-900 rounded-xl font-bold text-sm hover:bg-amber-300 transition"
          >
            {language === "np"
              ? "खाता सम्पादन गर्नुहोस्"
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-navy-950 rounded-xl border border-slate-800">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg border border-slate-800 text-xs text-white hover:bg-slate-800 transition"
            >
              {language === "np"
                ? "परिवर्तन"
                : "Change"}
          ...
          <div className="flex items-center justify-between p-3 bg-navy-950 rounded-xl border border-slate-800">
            ...
            <label className="inline-flex items-center cursor-pointer">
              ...
              <div
                className={`w-11 h-6 rounded-full ${twoFA
                    ? "bg-amber-400"
                    : "bg-slate-700"
                  } transition`}
              />
          ...
          <div className="p-3 bg-navy-950 rounded-xl border border-slate-800">
            ...
            <div className="mt-3 space-y-2">
              ...
              {sessions.length > 0 ? (
                sessions.map((session, index) => (
                  ...
                  <div
                    ...
                    className="text-xs p-2 bg-navy-900 rounded border border-slate-800 flex items-center justify-between gap-3"
                  >
              ...
              <div className="mt-2 flex gap-2">
                ...
                <button
                  onClick={logoutAll}
                  className="px-3 py-2 bg-red-600 text-white rounded-lg text-xs font-bold hover:bg-red-500 transition"
                >
                  {language === "np"
                    ? "सबै सत्रबाट लगआउट"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="p-3 bg-navy-950 rounded-xl border border-slate-800 flex items-center justify-between">
            ...
            <label className="inline-flex items-center cursor-pointer">
              ...
              <div
                className={`w-11 h-6 rounded-full ${locationPerm
                    ? "bg-amber-400"
                    : "bg-slate-700"
                  } transition`}
              />
          ...
          <div className="p-3 bg-navy-950 rounded-xl border border-slate-800 flex items-center justify-between">
            ...
            <div>
              <div className="text-sm font-bold text-white">
                {language === "np"
                  ? "व्यक्तिगत जानकारी दृश्यता"
                  : "Personal Info Visibility"}
              </div>

              <div className="text-xs text-slate-400">
                {language === "np"
                  ? "कसले मेरो जानकारी हेर्न सक्छ"
            ...
            <label className="inline-flex items-center cursor-pointer">
              ...
              <div
                className={`w-11 h-6 rounded-full ${personalVisible
                    ? "bg-amber-400"
                    : "bg-slate-700"
                  } transition`}
              />
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between p-3 bg-navy-950 rounded-xl border border-slate-800">
            ...
            <div>
              <div className="text-sm font-bold text-white">
                {language === "np"
                  ? "मेरो डेटा डाउनलोड गर्नुहोस्"
                  : "Download My Data"}
              </div>

              <div className="text-xs text-slate-400">
                {language === "np"
                  ? "तपाईंको एप डाटा डाउनलोड गर्नुहोस्"
            ...
            <button
              ...
              className="px-3 py-2 bg-amber-400 text-slate-900 rounded-lg font-bold text-xs hover:bg-amber-300 transition"
            >
              {language === "np"
                ? "डाउनलोड"
                : "Download"}
          ...
          <div className="flex items-center justify-between p-3 bg-navy-950 rounded-xl border border-slate-800">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400">
                {language === "np"
                  ? "यो कार्य स्थायी छ। कृपया सावधान हुनुहोस्।"
                  : "This action is permanent. Please proceed with caution."}
              </div>
            </div>

            <button
              onClick={() => setShowDeleteConfirm(true)}
              className="px-3 py-2 bg-red-600 text-white rounded-lg font-bold text-xs hover:bg-red-500 transition"
            >
              {language === "np"
                ? "मेटाउनुहोस्"
                : "Delete"}
